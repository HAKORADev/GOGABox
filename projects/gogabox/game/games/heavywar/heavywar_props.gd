...
## owner's as-is law, v040-1): plane 4 = sky, 3 = far background, 2 =
## background, 1 = ground; offset/y are the original 640x480 coords (the
## game scales them); mx is the per-frame scroll delta ADDED to the plane's
## own scroll; rare props appear once every few prop sets; nuke marks the
## destroyed-frame props (the strip's last frame is the wreck).
...
const PROPS := [
	...
	{"p": "frostkrai", "tex": "res://assets/games/hwsrc/anims/frigistan/snocommie_keyed.png", "frames": 2, "speed": 0.0, "plane": 1, "offset": 700.0, "y": 377.0, "mx": 0.0, "type": "looping", "nuke": true, "rare": true},
	...
	{"p": "gulfgate", "tex": "res://assets/games/hwsrc/anims/blastnya/lighthouse_keyed.png", "frames": 2, "speed": 0.0, "plane": 2, "offset": 350.0, "y": 170.0, "mx": 0.0, "type": "looping", "nuke": true, "rare": true},
	...
	{"p": "oilreach", "tex": "res://assets/games/hwsrc/anims/petrovakia/GasPill_keyed.png", "frames": 2, "speed": 0.0, "plane": 1, "offset": 640.0, "y": 382.0, "mx": 0.0, "type": "looping", "nuke": true, "rare": false},
	...
	{"p": "dunefort", "tex": "res://assets/games/hwsrc/anims/antagonistan/oasis_keyed.png", "frames": 2, "speed": 0.0, "plane": 2, "offset": 220.0, "y": 300.0, "mx": 0.0, "type": "looping", "nuke": true, "rare": false},
	...
	{"p": "steelcrown", "tex": "res://assets/games/hwsrc/anims/killingrad/Statue2_keyed.png", "frames": 2, "speed": 0.0, "plane": 2, "offset": 0.0, "y": 190.0, "mx": -0.3, "type": "looping", "nuke": true, "rare": false},
	{"p": "steelcrown", "tex": "res://assets/games/hwsrc/anims/killingrad/Statue1_keyed.png", "frames": 2, "speed": 0.0, "plane": 2, "offset": 400.0, "y": 195.0, "mx": -0.3, "type": "looping", "nuke": true, "rare": false},
