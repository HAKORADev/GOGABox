...
const GAMES := [
    ...
    {"id": "plays_t2", "title": "The War's Resident", "desc": "Play 40 rounds", "tier": 2, "rule": {"k": "stat", "key": "plays", "v": 40}},
        ...
        {"id": "fourline", "title": "FOUR IN LINE", "tag": "drop and connect",
                ...
                "thumb": "res://assets/thumbs/fourline.png",
                # v0.3.9 THE GRADUATION (the owner's GDD round): vertical
                # only, the xo economy with bonus /3, a GOGACoin after
                ...
                "controls": ["TAP ANYWHERE TO START - then tap a column to drop your disc (drag across the columns to aim first, the ghost shows the seat)",
                        "four in a row, column, or diagonal wins - win +1, loss -1 (your score never goes under zero), a full board draws",
                        "the loser of a round opens the next; a draw swaps the opener",
                        "after every 4 rounds a GOGACoin rests in a hole - land your disc on it first, the CPU races you",
                        "the bank is in the pause sheet: END ends the run and pays (run bonus /3)",
                        "the shop wears 5 disc pairs and 5 sets (frame + room) - everything past CLASSIC and TAVERN is bought"],
                "genres": {"main": ["strategy", "casual"], "sub": ["turnbased", "competitive", "singleplayer"]},
                "ach": [
    {"id": "score_t1", "title": "First Connect", "desc": "Score 5 in one run", "tier": 1, "rule": {"k": "max", "key": "max_score", "v": 5}},
    {"id": "score_t2", "title": "Column Sense", "desc": "Score 15 in one run", "tier": 2, "rule": {"k": "max", "key": "max_score", "v": 15}},
    {"id": "score_t3", "title": "The Drop Lord", "desc": "Score 40 in one run", "tier": 3, "rule": {"k": "max", "key": "max_score", "v": 40}},
    {"id": "score_t4", "title": "The Four Slayer", "desc": "Score 100 in one run", "tier": 4, "rule": {"k": "max", "key": "max_score", "v": 100}},
    {"id": "wins_t1", "title": "Connected!", "desc": "Win 10 rounds total", "tier": 1, "rule": {"k": "cnt", "key": "wins", "v": 10}},
    {"id": "wins_t2", "title": "The Loud Board", "desc": "Win 50 rounds total", "tier": 2, "rule": {"k": "cnt", "key": "wins", "v": 50}},
    {"id": "wins_t3", "title": "The Gravity Hand", "desc": "Win 200 rounds total", "tier": 3, "rule": {"k": "cnt", "key": "wins", "v": 200}},
    ...
    {"id": "plays_t2", "title": "The Board's Resident", "desc": "Play 40 rounds", "tier": 2, "rule": {"k": "stat", "key": "plays", "v": 40}},
        ...
        {"id": "bovo", "title": "FIVE IN ROW", "tag": "five in a row",
                ...
                "thumb": "res://assets/thumbs/bovo.png",
                # v0.3.9 THE GRADUATION (the owner's GDD round; the teaser
                # FIVE LINES is renamed FIVE IN ROW by the owner): vertical
                # only, the xo economy with bonus /2, a GOGACoin after each
                # 3 rounds on an intersection - the stone placed there
                ...
                "controls": ["TAP ANYWHERE TO START - tap an intersection to place your stone (the ghost previews the point, lift to confirm)",
                        "five in a row, column, or diagonal wins - win +1, loss -1 (your score never goes under zero), a full board draws",
                        "the loser of a round opens the next; a draw swaps the opener",
                        "after every 3 rounds a GOGACoin rests on an intersection - place a stone on it first, the CPU races you",
                        "OPTIONS switches the board: 8x8 free, 10x10 and 12x12 bought in the shop first (the 2048 way - switch starts a fresh board)",
                        "the bank is in the pause sheet: END ends the run and pays (run bonus /2)",
                        "the shop wears 5 stone pairs and 5 boards (slab + room) - everything past CHARCOAL and HONEY is bought"],
                "genres": {"main": ["strategy", "puzzle"], "sub": ["turnbased", "competitive", "singleplayer"]},
                "ach": [
    {"id": "score_t1", "title": "First Five", "desc": "Score 5 in one run", "tier": 1, "rule": {"k": "max", "key": "max_score", "v": 5}},
    {"id": "score_t2", "title": "Line Sense", "desc": "Score 15 in one run", "tier": 2, "rule": {"k": "max", "key": "max_score", "v": 15}},
    {"id": "score_t3", "title": "The Long Line", "desc": "Score 40 in one run", "tier": 3, "rule": {"k": "max", "key": "max_score", "v": 40}},
    {"id": "score_t4", "title": "The Five Master", "desc": "Score 100 in one run", "tier": 4, "rule": {"k": "max", "key": "max_score", "v": 100}},
    {"id": "wins_t1", "title": "Five!", "desc": "Win 10 rounds total", "tier": 1, "rule": {"k": "cnt", "key": "wins", "v": 10}},
    {"id": "wins_t2", "title": "The Quiet Board", "desc": "Win 50 rounds total", "tier": 2, "rule": {"k": "cnt", "key": "wins", "v": 50}},
    {"id": "wins_t3", "title": "The Stone Reader", "desc": "Win 200 rounds total", "tier": 3, "rule": {"k": "cnt", "key": "wins", "v": 200}},
    {"id": "streak_t1", "title": "Relentless", "desc": "Win 5 rounds in a row", "tier": 2, "rule": {"k": "max", "key": "streak", "v": 5}},
    {"id": "coins_t1", "title": "Coin Snatcher", "desc": "Take 25 GOGACoins total", "tier": 1, "rule": {"k": "cnt", "key": "coins_taken", "v": 25}},
    {"id": "plays_t1", "title": "Regular", "desc": "Play 8 rounds", "tier": 1, "rule": {"k": "stat", "key": "plays", "v": 8}},
    {"id": "plays_t2", "title": "The Board's Resident", "desc": "Play 40 rounds", "tier": 2, "rule": {"k": "stat", "key": "plays", "v": 40}},
    ...
    {"id": "plays_t2", "title": "The Table's Resident", "desc": "Play 40 runs", "tier": 2, "rule": {"k": "stat", "key": "plays", "v": 40}},
        ...
        "needs_games": 11},
                "desc": "THE TANK THAT NEVER STOPS, REBUILT: a survival rogue-like through 10 places - iron wasteland, scorched mesa, frozen tundra, volcanic core, toxic swamp, crystal caverns, sky archipelago, abyssal trench, neon sprawl and THE VOID - 10 waves each, a BOSS after every 10th wave, then a tunnel to the next place, and after place 10 the whole war loops harder. The left half of the screen is your analog roll (touch and slide), the right half is the aim - hold to fire the main cannon; the machine guns and the rocket pods are bought in the SCRAP SHOP and unlock on the tank for real. Every XP orb is one point - level up and pick your boost cards. Every scrap piece is one scrap - it banks when the run ends and the SCRAP SHOP spends it: wheels, hull plating, the main cannon, the auto-loader, the salvage claw, the neural link, the magnet coil, MG barrels + racks and rocket pods + racks, all with the honest MAX and LOCKED states. Enemies and bosses grow with your power - carpet bombers, shred bombers, shadow lancers with their under-burn lasers, and heavy machines that burst into falling shreds. Kills are the score; a GOGACoin rides the next kill every 22 kills or 40 seconds - bosses pay 5.",
                "controls": [
                        "tap anywhere to open the menu, then DEPLOY (or the SCRAP SHOP)",
                        "LEFT half of the screen: touch and slide - the tank rolls with your thumb (small slide = slow, big slide = fast)",
                        "RIGHT half: your finger IS the aim (the crosshair shows it) - hold to fire the main cannon; it is the only weapon that follows the aim",
                        "machine guns (when bought) fire straight up on their own; rocket pods (when bought) launch one rocket per pod, each tracking its OWN target",
                        "every XP orb is one point - level up mid-run and pick 1 of 3 boost cards; the back button never closes the cards",
                        "every scrap piece is one scrap - it banks when the run ends; the SCRAP SHOP spends the bank: wheels, hull, cannon, auto-loader, salvage claw, neural link, magnet coil, MG barrels, rocket pods and their racks",
                        "10 waves per place, a BOSS after every 10th wave, then the tunnel carries you to the next place - after place 10 the war loops, harder",
                        "a GOGACoin rides the next kill every 22 kills or 40 seconds - bosses pay 5; the score bonus is the score divided at the box gate",
                ],
    ...
    {"id": "plays_t1", "title": "Regular", "desc": "Play 8 rounds", "tier": 1, "rule": {"k": "stat", "key": "plays", "v": 8}},
        ...
        # middle of the pack - the newest game walks LAST (the feed
        # sorts buckets by this file's order). Moved to the end below.
        # AND THE SOON SHELF IS BACK: when SNAKES & LADDERS graduated
        # (v0.3.9-12) the workshop emptied and the next four names of
        # the SOON shelf never got their teaser entries - the owner
