...
const GAMES := [
        ...
        # style): direct reveal, 100 charges, 3 games, 400 coins.
        {
                ...
                "controls": [
                        "tap START, then tap a folk card and tap GREEN grass to place it (red cells are road, water or blocked)",
                        ...
                        "TARGET cycles FIRST / LAST / STRONG / CLOSE; SELL pays back",
                        "the pink NEXT WAVE button calls the wave early (bonus) or stacks the next wave on a running one",
                        "AUTO / MANUAL owns the wave clock; the speed chip cycles x1 x2 x3; PAUSE freezes the siege",
                        "MAPS opens the 30-map wall (every map wears day and night); the SHOP sells folk and maps for GOGACoins",
                ],
