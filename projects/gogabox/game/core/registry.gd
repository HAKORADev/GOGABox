...
const GAMES := [
    ...
    {"id": "plays_t2", "title": "The Table's Resident", "desc": "Play 40 runs", "tier": 2, "rule": {"k": "stat", "key": "plays", "v": 40}},
        ...
        "needs_games": 11},
                "desc": "THE TANK THAT NEVER STOPS, REBUILT: a survival rogue-like through 10 places - iron wasteland, scorched mesa, frozen tundra, volcanic core, toxic swamp, crystal caverns, sky archipelago, abyssal trench, neon sprawl and THE VOID - 10 waves each, a BOSS after every 10th wave, then a tunnel to the next place, and after place 10 the whole war loops harder. The left half of the screen is your analog roll (touch and slide), the right half is the aim - hold to fire the cannon, the MG nests and rocket pods fight with you. Level up and pick your boost cards; die and the war chest takes over: hull, cannon, wheels, the MG nests, rocket pods, four MINI TANKS (rocket, gunner, frost, magnet) and the skins - all bought with GOGACoins. Enemies and bosses grow with your power. Kills are the score; a coin rides the next kill every 22 kills or 40 seconds.",
                "controls": [
                        ...
                        "RIGHT half: your finger IS the aim - hold to fire the cannon while it stays",
                        "level up mid-run: pick 1 of 3 boost cards - damage, fire rate, pierce, ricochet, cryo and more",
                        ...
                        "a GOGACoin rides the next kill every 22 kills or 40 seconds - bosses pay 5",
                        "the WAR CHEST (shop) sells hull, cannon, wheels, MG nests, rocket pods, four MINI TANKS and the skins",
                ],
