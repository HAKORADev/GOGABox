...
const GAMES := [
        ...
        # style): direct reveal, 100 charges, 3 games, 400 coins.
        {
                ...
                "controls": [
                        "tap START, then pick a folk card by tap or DRAG it onto green grass (red cells are road, water or blocked)",
                        ...
                        "MAPS opens the 30-map wall (every map wears day and night); the SHOP sells folk and maps for GOGACoins; both close with X",
