...
const GAMES := [
        ...
        },
        {
                ...
                "desc": "Dario fell into this world through a Witcher's curse. Ten levels of stomp, dodge and deja vu to the end line - where SHE waits. Crush the Witcher (20 stomps, dodge her curses) and escape... probably. A mario-like with ? crates (the GOGACoins live inside them), timed ghost platforms, a shop (the night sky, three powerups), 3 lives and a story that remembers you.",
                "controls": [
                        "hold the LEFT half of the screen and slide to walk left/right",
                        "tap the RIGHT side to jump - land on enemies to stomp them",
                        "every enemy kind pays its own points (5 to 25); blockers take 3 stomps; the spiky turtle kills only while its spikes are OUT",
                        "bump ? crates from below: a GOGACoin pops out (5 a level), a powerup - or nothing at all",
