...
Parked after v0.1.7 (2026-08-31). State right now, owner's call: no new games
...
- **the rest of the python game box games** — carried over with proper
  redesigns (real art, box economy, chain), not straight ports.
  - **snowy tower** is one of these and it IS the doodle-jump-like — so NO
