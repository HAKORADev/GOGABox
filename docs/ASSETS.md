...
## v0.3.2 PATCH III audio + thumbnail (2026-09)
- assets/audio/music/inv_tour.wav, inv_finale.wav - REGENERATED by
  tools/v032c_audio.py: stereo 44.1kHz arrangements (kick/snare/hats, saw
  bass, detuned pads, echoing lead), deterministic, no external sources.
- assets/audio/sfx/inv_* (18 combat/radio voices) - REGENERATED by the same
  script with sub bodies + blast layers + longer tails. Originals by the
  v0.3.2 pass remain for the quiet voices (coin/power/heart/switch/click).
